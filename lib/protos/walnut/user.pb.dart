...
class User extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'User', package: const $pb.PackageName(_omitMessageNames ? '' : 'walnut.user'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'username')
    ..aOS(3, _omitFieldNames ? '' : 'firstName')
    ..aOS(4, _omitFieldNames ? '' : 'lastName')
    ..pc<Role>(5, _omitFieldNames ? '' : 'role', $pb.PbFieldType.PM, subBuilder: Role.create)
  ...
  @$pb.TagNumber(5)
  $core.List<Role> get role => $_getList(4);
}
...
class Role extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Role', package: const $pb.PackageName(_omitMessageNames ? '' : 'walnut.user'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
